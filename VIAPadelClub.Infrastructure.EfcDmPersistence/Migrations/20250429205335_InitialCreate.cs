    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Courts", x => x.CourtName);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_Courts_CourtName",
                        column: x => x.CourtName,
                        principalTable: "Courts",
                        principalColumn: "CourtName",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyScheduleCourts", x => new { x.ScheduleId, x.CourtName });
                    table.ForeignKey(
                        name: "FK_DailyScheduleCourts_Courts_CourtName",
                        column: x => x.CourtName,
                        principalTable: "Courts",
                        principalColumn: "CourtName",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DailyScheduleCourts_DailySchedules_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "DailySchedules",
                        principalColumn: "ScheduleId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyScheduleCourts_CourtName",
                table: "DailyScheduleCourts",
                column: "CourtName");
        }
