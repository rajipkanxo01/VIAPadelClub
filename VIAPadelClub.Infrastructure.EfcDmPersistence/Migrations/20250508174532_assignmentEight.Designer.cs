...
namespace VIAPadelClub.Infrastructure.EfcDmPersistence.Migrations
{
    ...
    [Migration("20250508174532_assignmentEight")]
    partial class assignmentEight
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VIAPadelClub.Core.Domain.Aggregates.Players.Player", b =>
                {
                    ...
                    b.OwnsOne("VIAPadelClub.Core.Domain.Aggregates.Players.Entities.VipMemberShip", "vipMemberShip", b1 =>
                        {
                            b1.Property<string>("Playeremail")
                                .HasColumnType("TEXT");
                            ...
                            b1.Property<DateOnly>("VIPEndDate")
                                .HasColumnType("TEXT")
                                .HasColumnName("VIPEndDate");

                            b1.Property<DateOnly>("VIPStartDate")
                                .HasColumnType("TEXT")
                                .HasColumnName("VIPStartDate");
